if defined?(RailsPerformance)
  RailsPerformance.setup do |config|
    ...
    rails_performance_password = ENV["RAILS_PERFORMANCE_PASSWORD"].presence || Rails.application.credentials.dig(:rails_performance, :password)
    config.http_basic_authentication_enabled = rails_performance_password.present?
    config.http_basic_authentication_user_name = "stardance"
    config.http_basic_authentication_password = rails_performance_password || ""
