class Api::V1::ProjectBountiesController < Api::V1::BaseController
  API_KEY_HEADER = "x-api-key".freeze
  WORKPLACE_ID_HEADER = "x-workplace-id".freeze
  MAX_BODY_BYTES = 64.kilobytes

  def create
    result = ExternalDashboard::ProjectBountyProcessor.call(parsed_body)
  ...
  private
    ...
    def reject_auth(reason)
      Rails.logger.warn "[ProjectBounties] rejected: #{reason}"
      false
    end
end
